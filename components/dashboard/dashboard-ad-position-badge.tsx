...
const DashboardAdPositionBadge: React.FC<DashboardAdPositionBadgeProps> = (
  ...
  const positionToVariantMap: Record<AdPosition, BadgeProps["variant"]> = {
    ...
    download_below_header: "success",
    downloading_page: "success",
    ...
    single_download_above_content: "success",
    single_download_below_content: "success",
    single_download_middle_content: "success",
    single_download_pop_up: "success",
